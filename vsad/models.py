...
class FewsSeries(models.Model):
    ...
    fechaforecast = models.DateTimeField(db_column='FechaForecast')  # Field name made lowercase.
...
class VariableForecast(models.Model):
    ...
    estacion = models.ForeignKey(InfoEstacion,db_column='Estacion', on_delete=models.DO_NOTHING)  # Field name made lowercase.
