...
#                                            null=True)  # Field name made lowercase.
    ...
    def __str__(self):
        return str(self.po_codigo) + ":" + str(self.po_descripcion)
...
class Rios(models.Model):
    ...
    def __str__(self):
        return str(self.ri_codigo) + ":" + str(self.ri_descripcion)
...
class TiposSenales(models.Model):
    ...
    ts_falta = models.DateTimeField(db_column='TS_FALTA', blank=True, null=True, editable=False)  # Field name made lowercase.
    ts_fmodif = models.DateTimeField(db_column='TS_FMODIF', blank=True, null=True, editable=False)  # Field name made lowercase.
    ...
    def __str__(self):
        return str(self.ts_codigo) + '_' + str(self.ts_descripcion)
...
#    ls_tipo_senal = models.CharField(db_column='LS_TIPO_SENAL', max_length=5, blank=True, null=True)  # Field name made lowercase.
    ls_tipo_senal = models.ForeignKey(TiposSenales, db_column='LS_TIPO_SENAL', on_delete=models.DO_NOTHING)  # Field name made lowercase.
    ...
    ls_tipo_consolidacion = models.ForeignKey(TiposConsolidacion, db_column='LS_TIPO_CONSOLIDACION', on_delete=models.DO_NOTHING)  # Field name made lowercase.
