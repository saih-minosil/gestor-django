...
var iconos={
    ...
    iconoAforoMuyBajo : new EstacionIcon({iconUrl: 'main_app/static/main_app/img/ico_a_bb.png'}),
    iconoNivelMuyBajo : new EstacionIcon({iconUrl:'main_app/static/main_app/img/ico_n_bb.png'}),
    iconoAforoBajo : new EstacionIcon({iconUrl: 'main_app/static/main_app/img/ico_a_b.png'}),
    iconoNivelBajo : new EstacionIcon({iconUrl:'main_app/static/main_app/img/ico_n_b.png'}),    
